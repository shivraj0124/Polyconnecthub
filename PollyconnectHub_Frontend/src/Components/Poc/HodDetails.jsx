...
function HodDetails() {
  ...
  const getAllHod = async () => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/poc/getAllHodPoc`,
        {
          page: page,
          rows: rowsPerPage,
  ...
  const handleAddHod = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/poc/addHOD`,
        {
          email: email,
          mobileNo: mobileNo,
          userType: "poc",
  ...
  const handleSearch = async (search) => {
    ...
    try {
      const response = await axios.post(
        `${VITE_BACKEND_API}/api/poc/searchHod`,
        {
          search: search,
          allocated_college: userDetails.College,
        }
  ...
  const handleDeleteHod = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/poc/delete_HOD`,
        {
          hod_id: deleteHod.id,
          userType: "poc",
        },
  ...
  const handleEditHod = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/poc/editHodPoc`,
        {
          id: editHod.id,
          email: email,
          mobileNo: mobileNo,
  ...
  const getAllDptAddHod = async () => {
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/dpt/getAllDptAddHod`,
        {
          college: userDetails.College,
        }
      );
