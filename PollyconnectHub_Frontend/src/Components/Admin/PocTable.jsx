...
function PocTable() {
  ...
  const getAllPoc = async () => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/admin/getPocAdmin`,
        {
          page: page,
          rows: rowsPerPage,
        }
  ...
  const handleAddPoc = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/admin/addPoc`,
        {
          email: email,
          mobileNo: mobileNo,
          college: college,
  ...
  const handleSearch = async (search) => {
    ...
    try {
      const response = await axios.get(
        `${VITE_BACKEND_API}/api/admin/searchPoc`,
        {
          params: { search },
        }
      );
  ...
  const handleDeletePoc = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/admin/deletePOC`,
        {
          poc_id: deletePoc.id,
          userType: "admin",
        },
  ...
  const handleEditPoc = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${VITE_BACKEND_API}/api/admin/editPoc`,
        {
          id: editPoc.id,
          email: email,
          phone: mobileNo,
  ...
  useEffect(() => {
    getAllPoc();
  }, [page, pagesize, pageNumber,changeState]);
  return (
